...
public class BuscaAgendamentoUseCaseImpl implements BuscaAgendamentoUseCase {
    ...
    @Override
    public List<AgendamentoDomain> buscaAgendamento(Long pacienteId,
                                                    Long medicoId,
        ...
        return this.agendamento.buscaAgendamento(pacienteId, medicoId, tipo, status, especialidade, dataAgendamento);
    }
}
